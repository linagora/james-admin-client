...
var httpClient = __webpack_require__(13);

var domainsApi = __webpack_require__(32);
var quotaApi = __webpack_require__(33);
var domainMappingsApi = __webpack_require__(34);
var groupApi = __webpack_require__(35);
var usersApi = __webpack_require__(36);
var forwardApi = __webpack_require__(37);
var mailRepositoriesApi = __webpack_require__(38);
var dataLeakPreventionApi = __webpack_require__(39);
var userAliasesApi = __webpack_require__(40);
var deletedMessages = __webpack_require__(41);
var tasksApi = __webpack_require__(42);
var healthCheckApi = __webpack_require__(43);
...
var Client = function () {
  ...
  _createClass(Client, [{
    ...
    value: function api(config) {
      return this.httpClient(config).then(function (resp) {
        return resp.data;
      });
    }
  }]);
...
function mixin(client) {
  ...
  client.listDomainAliases = function (domain) {
    return client.api({
      url: BASE_PATH + '/' + domain + '/aliases'
    });
  };

  client.addDomainAlias = function (domain, alias) {
    return client.api({
  ...
  client.removeDomainAlias = function (domain, alias) {
    return client.api({
      url: BASE_PATH + '/' + domain + '/aliases/' + alias,
      method: 'DELETE'
    });
...
var QUOTA_SIZE_PATH = 'size';
var QUOTA_COUNT_PATH = 'count';
...
function mixin(client) {
  ...
  client.deleteQuotaCount = function () {
    return client.api({
  ...
  client.deleteQuotaSize = function () {
    return client.api({
  ...
  client.deleteUserQuotaCount = function (username) {
    return client.api({
  ...
  client.deleteUserQuotaSize = function (username) {
    return client.api({
  ...
  client.deleteDomainQuotaCount = function (domain) {
    return client.api({
  ...
  client.deleteDomainQuotaSize = function (domain) {
    return client.api({
...
function mixin(client) {
  client.users = {
    create: create,
    getAllowedFromHeaders: getAllowedFromHeaders,
    list: list,
    remove: remove,
    update: update
  };
...
var BASE_PATH = '/address/forwards';
var DESTINATION_CONTEXT = 'targets';

module.exports = function (client) {
  client.forward = {
    addDestination: addDestination,
    list: list,
    listDestinationsOfForward: listDestinationsOfForward,
...
var BASE_PATH = '/mailRepositories';
...
function mixin(client) {
  client.mailRepositories = {
    ...
    removeAllMails: removeAllMails,
    reprocessAllMails: reprocessAllMails,
    reprocessMail: reprocessMail
  };
  ...
  function getMails(repositoryId) {
  ...
  function reprocessAllMails(repositoryId) {
    var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        processor = _ref2.processor,
        queue = _ref2.queue;

    var action = 'reprocess';

    return client.api({
      url: BASE_PATH + '/' + encodeURIComponent(repositoryId) + '/mails',
      method: 'PATCH',
      params: { action: action, processor: processor, queue: queue }
    });
  }

  function reprocessMail(repositoryId, mailKey) {
...
var BASE_PATH = '/address/aliases';

module.exports = function (client) {
  client.listUsersHavingAliases = function () {
    return client.api({
      url: BASE_PATH
    });
  };

  client.listUserAliases = function (user) {
    return client.api({
      url: BASE_PATH + '/' + encodeURIComponent(user)
    });
  };

  client.addUserAlias = function (user, alias) {
    return client.api({
  ...
  client.removeUserAlias = function (user, alias) {
    return client.api({
      url: BASE_PATH + '/' + encodeURIComponent(user) + '/sources/' + encodeURIComponent(alias),
      method: 'DELETE'
    });
...
var BASE_PATH = '/deletedMessages/users';

module.exports = function (client) {
  client.restoreDeletedMessages = function (user, criterials) {
    return client.api({
  ...
  client.exportDeletedMessages = function (user, receiveUser, criterials) {
    return client.api({
...
function mixin(client) {
  client.getTask = function (id) {
    return client.api({ url: BASE_PATH + '/' + id });
  };
}
...
var BASE_PATH = '/healthcheck';

module.exports = function (client) {
  client.healthCheck = {
    get: get,
    getOneComponent: getOneComponent,
    listAllHealthChecks: listAllHealthChecks
  };
...
//# sourceMappingURL=james-admin-client.js.map